# History — Chapters 0 to 15

The CHANGELOG entries for the first fifteen chapters, moved here from
[CHANGELOG.md](../CHANGELOG.md) unchanged so that the CHANGELOG stays readable.
Newest first. Later chapters refer to these by number.
